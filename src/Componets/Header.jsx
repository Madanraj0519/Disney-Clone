...
function Header() {
  ...
  return (
    ...
    <div className='hidden md:flex gap-8'>
        ...
        <div className='absolute top-8 w-20 right-0 bg-[#121212] border
         border-slate-900 rounded-lg shadow-sm shadow-zinc-50 p-2 
         text-sm  opacity-0 hover:opacity-100 duration-200'>
            ...
            <>
              <button className='bg-black py-2 px-4 uppercase border text-white border-[#f9f9f9] rounded-lg duration-200 cursor-pointer
               hover:bg-[#f9f9f9] hover:text-[#000] border-transparent' onClick={handleAuth}>Login</button>
            </>
        }
    </div>
  )
